...
*   **Tus Datos**: Las API Keys se guardan localmente en tu PC (`%APPDATA%\AntivirusScanner`). No se envían a ningún servidor externo salvo a VirusTotal (solo los hashes de los archivos).
